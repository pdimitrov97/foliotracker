 ...
 * obtains the stock value by using the website:
 * <a href="http://www.tickertech.com"> <tt>http://www.tickertech.com</tt> </a>
 * <Br>
 * Examples of ticker symbols are <tt>MSFT</tt> and <tt>orcl</tt>. (Note that
 * ticker symbols are not case sensitive. That is that "MSFT" and "msft" are
...
public class StrathQuoteServer
{
	 ...
	 *           period separating dollars and cents (eg, "120.50" for one hundred
	 *           and twenty dollars and fifty cents) <BR>
	 *           unless tickerSymbol is not a valid NYSE or NASDAQ symbol, when
	 *           throws NoSuchTickerException <br>
	 *           or unless an error connecting to the website or some other error
	 *           occurs, when throws WebsiteDataException <BR>
	 *           The amount returned may contain commas, for example, "2,243.87"
	 *           <br>
	 */
	public static String getLastValue(String tickerSymbol) throws WebsiteDataException, NoSuchTickerException
	{
